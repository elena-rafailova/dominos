            ...
            <div class="col-md-6 mx-auto " >
                <div class="input-group mb-1">
                    ...
                    <div class="form-group mx-auto" style="width: 35%">
                        ...
                        <input type="text" class="form-control  w-50 mx-auto" maxlength="4" name="street_number" required /><br>
                    </div>
                    <div class="form-group  mx-auto">
                    ...
                    <div class="form-group mx-auto" style="width: 35%;">
                        ...
                        <input type="text" class="form-control w-50 mx-auto" maxlength="4" name="floor"/><br>
                    </div>
                </div>
            </div>
                <div class="col-md-6 mx-auto " >
